...
from src.beats.beat_track import make_beat_grid, build_bar_grid

from src.chords.chord_recognition import recognize_chords, simplify_chord

from src.lyrics.pipeline import extract_vocals, get_timestamped_lyrics
...
def generate_chord_chart(audio_path):
    ...
    output_path = os.path.splitext(audio_path)[0] + "_chart.json"
